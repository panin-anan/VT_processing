...
if ext == ".tdms":
    with TdmsFile.open(file_path) as tdms_file:
        ...
        response_channels = [
        "L5-Z", "L6-Z", "L7-Z", "L8-Z", "L9-Z", "L10-Z", "L11-Z", "L12-Z",
        "L13-Z", "L14-Z",
        "R5-Z", "R6-Z", "R7-Z", "R8-Z", "R9-Z", "R10-Z", "R11-Z", "R12-Z",
        "R13-Z", "R14-Z"
        ]
        acc_list = []
...
unv_path = os.path.join(save_dir, f"{base_name}_exp_modes_test3.unv")
